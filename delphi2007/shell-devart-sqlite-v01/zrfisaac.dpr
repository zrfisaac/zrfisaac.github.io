...
const
  ...
  cAboutVersionName = 'zrfisaac.delphi2007.shell.devart.sqlite.v01';
...
begin
  ...
  try
    ...
    begin
      ...
      vConfig.Values['DriverName'] := 'DevartSQLite';
      vConfig.Values['ConnectionName'] := 'Devart SQLite';
      vConfig.Values['GetDriverFunc'] := 'getSQLDriverSQLite';
      vConfig.Values['LibraryName'] := 'dbexpsqlite40.dll';
      vConfig.Values['VendorLib'] := 'dbexpsqlite40.dll';
      //vConfig.Values['HostName'] := 'localhost';
      //vConfig.Values['User_Name'] := 'sa';
      //vConfig.Values['Password'] := 'ABcd!@34';
      vConfig.Values['Database'] := 'master.db';
      vConfig.Values['Script'] := 'SELECT 1 AS A;';
