...
rem # - version : zrfisaac.choco.work04 : 1.0.0
...
echo # - version : zrfisaac.choco.work04 : 1.0.0
echo.
...
set c_chocolatey=!c_chocolatey! notepadplusplus.install
set c_chocolatey=!c_chocolatey! postgres14
set c_chocolatey=!c_chocolatey! innosetup
...
set c_chocolatey=!c_chocolatey! libreoffice
